...
public class MainActivity extends AppCompatActivity {
    ...
    private void checkTheResult() { // phuong thuc kiem tra ket qua cua nguoi dung
        ...
        rg5Rb2 = (RadioButton) findViewById(R.id.rg5_rb2);
        Boolean quiz_5 = rg5Rb2.isChecked(); // Check dap an nguoi dung chon
        if (quiz_5) { // Kiem tra nguoi dung nhap dung hay sai
            count += 1;
        }
        rg9Rb2 = (RadioButton) findViewById(R.id.rg9_rb2);
        Boolean quiz_9 = rg9Rb2.isChecked(); // Check dap an nguoi dung chon
