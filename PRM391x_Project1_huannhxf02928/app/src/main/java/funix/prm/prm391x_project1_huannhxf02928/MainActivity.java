...
public class MainActivity extends AppCompatActivity {
    ...
    public int counter = 60; // Dem so cau hoi nguoi dung lam dung
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_main); // Hien thi man hinh chính

        Button btnMove = findViewById(R.id.button1);
        btnMove.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                setContentView(R.layout.layout_quiz); // Hien thi man hinh quiz
                quizSubmit();
            }
        });
    }
